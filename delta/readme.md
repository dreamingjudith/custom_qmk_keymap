...
## LED indicator functionality for caps/scroll lock

Just clone [this repository](https://github.com/dreamingjudith/qmk_firmware) and build `indicator` keymap.  

    qmk compile -j 0 -kb acheron/apollo/87h/delta -km indicator

**Note:** It'll work only on [VIA web version](https://usevia.app/).
